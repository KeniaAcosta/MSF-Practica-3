...
Nombre del alumno:  Acosta Berrelleza Kenia Celeste
Número de control: 22210407
Correo institucional: l22210407@tectijuana.edu.mx
...
# Función para aplicar tratamiento a un sistema con controlador I
...
# GRAFICA 2: Normotenso, Hipertenso, tratamiento
...
plt.plot(t, respTratado, ':', linewidth=2, color=azul,
label='Tratamiento ')
plt.xlim(0, 10)
plt.ylim(-0.5, 2)
plt.xlabel('t [s]')
...
# GRAFICA : Normotenso, Hipotenso, tratamiento 
